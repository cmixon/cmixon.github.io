let ntp = {
    ...
    BCL2: "IGH::BCL2 rearrangement is most commonly associated with follicular lymphoma. It is also observed in diffuse large B-cell lymphomas among other lymphoma subtypes.",
    ...
    hgBCL2: "BCL2 rearrangements are observed in 90% of follicular lymphomas, 30% of diffuse large cell lymphoma (germinal center subtype) and rarely in other lymphoproliferative disorders.  This assay is not designed to identify the rearrangement partner.",
    ...
    hgMYCabove4f: "The abnormal signal pattern with the MYC breakapart probe is indicative of MYC amplification. B-cell lymphomas with MYC amplification (>4 signals)  may be aggressive but are not separately classified based on the amplification.",

    hgMYCandBCL2: " MYC gene rearrangement with concurrent BCL2 gene rearrangement is identified. In the appropriate morphologic setting, these results are indicative of the WHO5 category 'Diffuse large B-cell lymphoma/High-grade B-cell lymphoma with MYC and BCL2 rearrangements'.  This assay is not designed to identify the rearrangement partners.",

    hgMYCandBCL6: " MYC gene rearrangement with concurrent BCL6 gene rearrangement is identified. In the current WHO5 classification, these results may be seen in diffuse large B-cell lymphoma NOS or high-grade B-cell lymphoma NOS, depending on morphologic context.",

    hgMYCandBCL6andBCL2: " MYC gene rearrangement with concurrent BCL2 and BCL6 gene rearrangements is identified. In the appropriate morphologic setting, these results are included in the WHO5 category diffuse large B-cell lymphoma/high-grade B-cell lymphoma with MYC and BCL2 rearrangements.  This assay is not designed to identify the rearrangement partners. Although a significant number of cases will show MYC::BCL6 rearrangement, their mutational profiles are similar to cases with other rearrangement partners for MYC.  Please correlate with other clinical and laboratory findings.",
    ...
    possDHL: "Although no MYC rearrangement is identified by the MYC breakapart probe, the published false negative rate for this probe is approximately 4%. Since a BCL2 rearrangement is present in this case, further assessment for MYC rearrangement with the IGH/MYC dual fusion probe set should be considered."
